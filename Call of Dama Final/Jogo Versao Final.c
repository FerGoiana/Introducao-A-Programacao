...
int validaMovimento(char tab[][9], int l1, int c1, int l2, int c2, int p){
...
int main(){
	...
	int l,c,linha,coluna,g=0,cont,al1,al2,jogador=1,linha2,coluna2, x, p;
	char tab[9][9], letra[1000], movimento[1000];
	...
	do{
		...
		scanf("%s", movimento);
		while(getchar()!='\n');
        movimento [0]=tolower(movimento[0]);
		...
		while(validaMovimento(tab,linha,coluna,linha2,coluna2,p) !=1){
